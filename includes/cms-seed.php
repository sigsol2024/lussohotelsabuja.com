...
$siteSettings = [
    ...
    'nav_suites_href' => 'rooms.php',
    'nav_dining_href' => 'dining.php',
    'nav_experience_href' => 'amenities.php',
    'nav_events_href' => 'gallery.php',
...
$pageSections = [
    ...
    ['index', 'hero_cta_href', 'text', 'rooms.php'],
    ...
    ['index', 'home_philosophy_link_href', 'text', 'about.php'],
    ...
    ['index', 'home_rooms_view_all_href', 'text', 'rooms.php'],
    ...
    ['about', 'values_card_link_href', 'text', 'amenities.php'],
    ...
    ['about', 'cta_btn1_href', 'text', 'rooms.php'],
    ['about', 'cta_btn2', 'text', 'Contact Concierge'],
    ['about', 'cta_btn2_href', 'text', 'contact.php'],
    ...
    ['dining', 'visual_link_href', 'text', 'gallery.php'],
